...
void setup() {
  ...
  heartRateChar.setValue(oldHeartRate);   // initial value for this characteristic
...
void updateHeartRate() {
  ...
  */
  ...
  if (heartRate != oldHeartRate) {      // if the heart rate has changed
    ...
    heartRateChar.setValue(heartRate);  // and update the heart rate measurement characteristic
